            ...
            <div className="row">
              <div className="col-md-6">
                <div className="about_taital_box">
                  ...
                  <p className=" about_text">has a more-or-less normal distribution of letters, as opposed to using
                    'Content here, content here', making it look like readable English. Many desktop publishing
                    packages and web page editorhas a more-or-less normal distribution of letters, as oppos</p>
                ...
                <div className="client_section_2">
                  <div className="client_taital_main">
                    ...
                    <div className="client_right">
                      ...
                      <p className="client_text">now use Lorem Ipsum as their default model text, and a search for
                        'lorem ipsum' will uncover many web sites still in their infancynow use Lorem Ipsum as
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="blog_box">
                  ...
                  <p className="lorem_text">distracted by the readable content of a page when looking at its layout. The
            ...
            <div className="row">
              ...
              <div className="map_main">
                <div className="map-responsive">
                  <iframe
                    src="https://www.google.com/maps/embed/v1/place?key=AIzaSyA0s1a7phLN0iaD6-UE7m4qP-z21pH0eSc&amp;q=Marine+Drive+Mumbai"
